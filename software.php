        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Software Training</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Software Training</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <a href="video/Freemailer.exe" download>
                            <button type="button" class="btn btn-success waves-effect waves-light m-t-5">Freemailer</button>
                        </a>
                    </div>
                </div>
                <div class="row" style="margin-top: 25px;">
                    <!-- <div class="col-md-6">
                        <h4 class="card-title" id="0">1. Rapid Group Builder Setup</h4>
                        <video width="560" height="315" controls>
                            <source src="video/Rapid Group Builder Setup.mp4" type="video/mp4">
                        </video>
                    </div>
                    <div class="col-md-6">
                        <h4 class="card-title" id="0">2. How to Update Chrome Browser</h4>
                        <video width="560" height="315" controls>
                            <source src="video/How to Update Chrome Browser.mp4" type="video/mp4">
                        </video>
                    </div>
                    <div class="col-md-6">
                        <h4 class="card-title" id="0">3. SS Pro Training 8-18-20</h4>
                        <video width="560" height="315" controls>
                            <source src="video/SS Pro Training 8-18-20.mp4" type="video/mp4">
                        </video>
                    </div> -->
                </div>
            </div>
